...
To conclude the benchmarking of the final result against the best case scenario, it can be said that the performance numbers recorded in the best case scenario test could not be replicated. The fully optimized project's frame rate was 53.4 frames per second and the frame rate stability was 87.1\%. This means that 89\% of the frame rate goal and 87.1\% of the frame rate stability goal was achieved, which is considered a success by the author, as the measured numbers fit well within the envelope of user tolerance. A user's expectation is, as defined by Jakob Nielsen, a user interface that responds to their interaction in 100 milliseconds.\{NielsenUsabilityEngineering} The measurements in the final results show that the response time was in average, based on the average frame rate, 18.7 milliseconds.
