...
\paragraph*{Findings -}\hspace{-1em}
compares the combined result of all optimizations with positive impacts on user interface performance against the two reference points and analyzes the results.
...
%%%%%%%%%%%%%%%%%%%%%%%% %%%%%%%%%%%%%%%%%%%%%%%%%%
% Caching cell heights % % REVIEWED | T: + | G: + %
%%%%%%%%%%%%%%%%%%%%%%%% %%%%%%%%%%%%%%%%%%%%%%%%%%
...
\itkIncludeImage{test-5}{Performance test results after after implementing resizing of images}
...
\itkIncludeImage{test-8}{Performance test results using AsyncDisplayKit's classes and methodologies}
...
\itkIncludeImage{worst-vs-end}{Worst case scenario results benchmarked against the fully optimized project's test results}
...
\itkIncludeImage{best-vs-end}{Best case scenario results benchmarked against the end result's test results}
...
Nagu mainitud selle peatüki sissejuhatavas lõigus, on lõputöös esitatud kokku kaheksa teoreetilist töökiiruse parendamise viisi. Kaheksast lõputöös esitatud optimeerimisviisist kuus parendasin töökiirust ja kaks ei parendanud. Tehtud töö põhjal lõplike järelduste tegemiseks loodi niinimetatud lõpptulemust esindav projekt, ehk lõpptulemus, mis saadi kõikide töökiirust parendavate optimeerimisviiside lisamisel halvima testjuhu projektile. Saadud lõpptulemust võrreldi nii parima kui ka halvima testjuhuga.
