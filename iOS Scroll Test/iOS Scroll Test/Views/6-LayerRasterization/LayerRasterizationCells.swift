...
// -- TEXT CELL | OUT
// ---------------------------
class LayerRasterization_TextCell_Out: ReusableCell {
    ...
    override init(style: UITableViewCellStyle, reuseIdentifier: String?) {
        ...
        self._messageLabelWrap.layer.shouldRasterize = true
        self._messageLabelWrap.layer.rasterizationScale = UIScreen.main.scale
...
// -- TEXT CELL | IN
// ---------------------------
class LayerRasterization_TextCell_In: ReusableCell {
...
// -- MEDIA CELL | 1 | OUT
// ---------------------------
class LayerRasterization_MediaCell_1_Out: ReusableCell {
...
// -- MEDIA CELL | 1 | IN
// ---------------------------
class LayerRasterization_MediaCell_1_In: ReusableCell {
...
// -- MEDIA CELL | 2 | OUT
// ---------------------------
class LayerRasterization_MediaCell_2_Out: ReusableCell {
    ...
    override init(style: UITableViewCellStyle, reuseIdentifier: String?) {
        ...
        self._imageView_1.layer.shouldRasterize = true
        self._imageView_1.layer.rasterizationScale = UIScreen.main.scale
        ...
        self._imageView_2.layer.shouldRasterize = true
        self._imageView_2.layer.rasterizationScale = UIScreen.main.scale
    }
...
// -- MEDIA CELL | 2 | IN
// ---------------------------
class LayerRasterization_MediaCell_2_In: ReusableCell {
...
// -- MEDIA CELL | 3 | OUT
// ---------------------------
class LayerRasterization_MediaCell_3_Out: ReusableCell {
    ...
    override init(style: UITableViewCellStyle, reuseIdentifier: String?) {
        ...
        self._imageView_3.layer.shouldRasterize = true
        self._imageView_3.layer.rasterizationScale = UIScreen.main.scale
    }
...
// -- MEDIA CELL | 3 | IN
// ---------------------------
class LayerRasterization_MediaCell_3_In: ReusableCell {
