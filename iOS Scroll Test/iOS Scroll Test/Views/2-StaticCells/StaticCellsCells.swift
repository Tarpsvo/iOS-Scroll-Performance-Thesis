...
// -- TEXT CELL | OUT
// ---------------------------
class StaticCells_TextCell_Out: ReusableCell {
...
// -- TEXT CELL | IN
// ---------------------------
class StaticCells_TextCell_In: ReusableCell {
...
// -- MEDIA CELL | 1 | OUT
// ---------------------------
class StaticCells_MediaCell_1_Out: ReusableCell {
    ...
    override func updateFromMessage(message: Message) {
        self._imageView.pin_clearImages()
        self._imageView.pin_setImage(from: URL(string: message.mediaItems![0]))
    }
...
// -- MEDIA CELL | 1 | IN
// ---------------------------
class StaticCells_MediaCell_1_In: ReusableCell {
...
// -- MEDIA CELL | 2 | OUT
// ---------------------------
class StaticCells_MediaCell_2_Out: ReusableCell {
...
// -- MEDIA CELL | 2 | IN
// ---------------------------
class StaticCells_MediaCell_2_In: ReusableCell {
...
// -- MEDIA CELL | 3 | OUT
// ---------------------------
class StaticCells_MediaCell_3_Out: ReusableCell {
    ...
    override func updateFromMessage(message: Message) {
        ...
        self._imageView_3.pin_clearImages()
...
// -- MEDIA CELL | 3 | IN
// ---------------------------
class StaticCells_MediaCell_3_In: ReusableCell {
